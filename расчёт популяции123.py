...
lb_Xn1_otv=Label(root,bg="cyan",width=18)
...
lb_Xn2_otv=Label(root,bg="cyan",width=18)
...
lb_Xn3_otv=Label(root,bg="cyan",width=18)
...
ent_q=Entry(root,bg="white",width=6)
...
lb_n=Label(root,text="Циклы",bg="yellow",width=5)
...
bt3.bind("<Button-1>",ogr_rost_s_otlovom)
...
bt4.bind("<Button-1>",xichnik_gertva)
